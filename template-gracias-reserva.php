<?php 
	//Template name: Gracias Reserva Cupo - campaña Caídos del Cielo
?>
<!doctype html>
<html class="no-js" lang="">
  <head>
    ...
    <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/oportunidad/styles/main.css">
  ...
  <body>
    ...
    <!-- Google Code for Caido del cielo contacta Conversion Page -->
    ...
    var google_conversion_label = "navSCKSs82QQs5XUvAM";
    ...
    <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/932514483/?label=navSCKSs82QQs5XUvAM&amp;guid=ON&amp;script=0"/>
    </div>
    </noscript>
          ...
          <div class="col-sm-10 col-sm-offset-1">
            ...
            <div class="clear30"></div>
              ...
              <div class="col-sm-5">
                ...
                <div class="clear30"></div>
                <a href="/oportunidad-caida-del-cielo/" class="btn btn-naranjo">VOLVER</a>
              </div>
            </div>
          </div>
        </div>
